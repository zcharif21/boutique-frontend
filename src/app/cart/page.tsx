  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="grid md:grid-cols-3 gap-6">
            ...
            <div key={product.id} className="card flex gap-4 p-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-2">
                  ...
                  <button onClick={() => updateQty(product.id, Math.min(quantity + 1, product.stock_qty))}
                    className="w-7 h-7 border rounded-full flex items-center justify-center hover:bg-gray-100">
                    <Plus size={12} />
                  </button>
                  <button onClick={() => removeItem(product.id)} className="ml-auto text-red-400 hover:text-red-600">
                    <Trash2 size={16} />
                  </button>
                </div>
              </div>
        ...
        {/* Récapitulatif + formulaire livraison */}
